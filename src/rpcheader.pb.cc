...
constexpr RpcHeader::RpcHeader(
  ...
  , meghod_name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , args_size_(0u){}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpcheader::RpcHeader, meghod_name_),
  PROTOBUF_FIELD_OFFSET(::rpcheader::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpcheader::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpcheader::_RpcHeader_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, 111, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  meghod_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_meghod_name().empty()) {
    meghod_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_meghod_name(), 
      GetArena());
  }
...
void RpcHeader::SharedDtor() {
  ...
  meghod_name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_meghod_name();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  // bytes meghod_name = 2;
  if (this->meghod_name().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_meghod_name(), target);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:rpcheader.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpcheader.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpcheader.RpcHeader)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:rpcheader.RpcHeader)
  ...
  if (from.meghod_name().size() > 0) {
    _internal_set_meghod_name(from._internal_meghod_name());
  }
  if (from.args_size() != 0) {
...
// @@protoc_insertion_point(generalized_copy_from_start:rpcheader.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  meghod_name_.Swap(&other->meghod_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
template<> PROTOBUF_NOINLINE ::rpcheader::RpcHeader* Arena::CreateMaybeMessage< ::rpcheader::RpcHeader >(Arena* arena) {
