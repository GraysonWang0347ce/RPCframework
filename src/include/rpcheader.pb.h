...
class RpcHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  // bytes meghod_name = 2;
  void clear_meghod_name();
  const std::string& meghod_name() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_meghod_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_meghod_name();
  std::string* release_meghod_name();
  void set_allocated_meghod_name(std::string* meghod_name);
  private:
  const std::string& _internal_meghod_name() const;
  void _internal_set_meghod_name(const std::string& value);
  std::string* _internal_mutable_meghod_name();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr meghod_name_;
...
inline void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 
 service_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
// bytes meghod_name = 2;
inline void RpcHeader::clear_meghod_name() {
  meghod_name_.ClearToEmpty();
}
inline const std::string& RpcHeader::meghod_name() const {
  // @@protoc_insertion_point(field_get:rpcheader.RpcHeader.meghod_name)
  return _internal_meghod_name();
}
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void RpcHeader::set_meghod_name(ArgT0&& arg0, ArgT... args) {
 
 meghod_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
  // @@protoc_insertion_point(field_set:rpcheader.RpcHeader.meghod_name)
}
inline std::string* RpcHeader::mutable_meghod_name() {
  // @@protoc_insertion_point(field_mutable:rpcheader.RpcHeader.meghod_name)
  return _internal_mutable_meghod_name();
}
inline const std::string& RpcHeader::_internal_meghod_name() const {
  return meghod_name_.Get();
}
inline void RpcHeader::_internal_set_meghod_name(const std::string& value) {
  
  meghod_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* RpcHeader::_internal_mutable_meghod_name() {
  
  return meghod_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* RpcHeader::release_meghod_name() {
  // @@protoc_insertion_point(field_release:rpcheader.RpcHeader.meghod_name)
  return meghod_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RpcHeader::set_allocated_meghod_name(std::string* meghod_name) {
  if (meghod_name != nullptr) {
    
  } else {
    
  }
  meghod_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), meghod_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:rpcheader.RpcHeader.meghod_name)
}
