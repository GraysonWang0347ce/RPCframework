...
PROTOBUF_NAMESPACE_OPEN
template<> ::test::Login* Arena::CreateMaybeMessage<::test::Login>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace test {
...
class Login PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test.Login) */ {
 public:
...
inline const std::string& Login::name() const {
  // @@protoc_insertion_point(field_get:test.Login.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Login::set_name(ArgT0&& arg0, ArgT... args) {
 
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
  // @@protoc_insertion_point(field_set:test.Login.name)
}
inline std::string* Login::mutable_name() {
  // @@protoc_insertion_point(field_mutable:test.Login.name)
...
inline std::string* Login::release_name() {
  // @@protoc_insertion_point(field_release:test.Login.name)
...
inline void Login::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:test.Login.name)
}
...
inline const std::string& Login::password() const {
  // @@protoc_insertion_point(field_get:test.Login.password)
  return _internal_password();
}
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Login::set_password(ArgT0&& arg0, ArgT... args) {
 
 password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
  // @@protoc_insertion_point(field_set:test.Login.password)
}
inline std::string* Login::mutable_password() {
  // @@protoc_insertion_point(field_mutable:test.Login.password)
...
inline std::string* Login::release_password() {
  // @@protoc_insertion_point(field_release:test.Login.password)
...
inline void Login::set_allocated_password(std::string* password) {
  ...
  password_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), password,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:test.Login.password)
}
